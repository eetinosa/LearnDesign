...
coursenames = ["adobe-experience-design","color-theory","design-thinking","drawing","sketch","typography","wireframing","adobe-illustrator","prototyping","ux-research","user-interface-design","figma","user-experience-design"]
...
for i in range(len(coursenames)):
    ...
    for course in courses:
        ...
        CourseName.append(coursenames[i]) 

        AllCourses = pd.DataFrame({'Course': CourseTitles,
        'Votes': Votes,
